...
TrieSearch.prototype = {
  ...
  get: function (phrases, reducer) {
    ...
    // TODO need add a delete

    // console.log(this.keyFields, 'keyFieldskeyFields')
    // console.log(this.root, 'rootrootroot')
    // console.log(this.size, 'sizesizesize')
    // console.log(this.getCache, 'getCachegetCachegetCache')
